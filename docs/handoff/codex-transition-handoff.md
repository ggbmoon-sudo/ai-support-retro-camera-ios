...
- Recommended next work is Phase 21-N-R1D: One-fixture Local Model Smoke Retry Healthz Block Resolution. Do not run a model call during R1D; any later retry still requires separate explicit approval.
