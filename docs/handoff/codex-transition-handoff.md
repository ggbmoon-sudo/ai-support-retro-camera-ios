...
- Next planned phase after Phase 18-C3: continue Phase 18-C post-capture Advisor beta hardening only if explicitly requested and only as app-side/local or internal/debug beta work.
