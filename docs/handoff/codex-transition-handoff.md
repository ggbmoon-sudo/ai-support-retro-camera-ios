...
- Next planned phase after Phase 19-E: `Phase 19-F`, if explicitly requested. It should remain backend-only / local-synthetic unless the prompt explicitly approves a real local model benchmark.
