...
- Recommended next step is Phase 21-N-R1: Approved One-fixture Local Model Smoke Retry. This requires separate explicit user approval because it may run exactly one backend local/private model call. Do not run a model call or substitute another fixture token unless a future prompt explicitly approves it.
