...
- Recommended next step is Phase 21-N-R1B: One-fixture Local Model Smoke Retry Block Resolution. Resolve the ignored local config fixture-token mismatch without running a model call. Any future one-call retry still requires separate explicit approval.
