...
The research index for this direction is `../docs/research/on-device-ai-research-index.md`. Later Depth Anything / Florence work remains blocked until separately approved and benchmarked. The next practical step is MacBook/Xcode physical-device verification of Phase 21-A3-R5, then compare against `../docs/phase-roadmap-sequencing-and-next-action-register.md` before choosing the next phase.
