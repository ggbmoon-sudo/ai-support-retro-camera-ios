...
Phase OD-R4 is backend-only Cloud AI Teacher contract work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, crawler/download mode, image read/upload, cloud teacher runtime call, training, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R5A is backend-only Cloud AI Teacher sandbox preflight and stub-adapter work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, crawler/download mode, image read/upload, cloud teacher runtime call, training, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R6A is backend-only Parameter Candidate Runner dry-run work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, crawler/download mode, image read/upload, cloud teacher runtime call, training, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R6B is backend-only Human Review Queue schema work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, crawler/download mode, image read/upload, cloud teacher runtime call, training, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.
...
Phase OD-R7A is backend-only Local CV Feature Vector Benchmark dry-run work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R7B is backend/local-only Local CV Feature Extractor prototype work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training/fine-tuning, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R7C is backend/local-only Local CV calibration fixture gate work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, real image read, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image upload, cloud teacher runtime call, network call, training/fine-tuning, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R7D is backend/local-only ignored local fixture calibration smoke work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, Core ML package, model install, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image upload, cloud teacher runtime call, network call, training/fine-tuning, app runtime transfer, committed real photo/local config/generated report, or production rollout is added. The backend smoke may read one ignored local fixture only after local approval gates pass.

Phase OD-R7E is backend/local-only expected range comparison work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, Core ML package, model install, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image read by default, image upload, cloud teacher runtime call, network call, training/fine-tuning, app runtime transfer, committed real photo/local config/generated report, or production rollout is added. Camera remains unchanged and local/on-device guidance remains the direction.

Phase OD-R7F is backend/local-only calibration aggregation work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, app bundle artifact, Camera behavior, live cloud AI path, upload path, provider/model key, direct provider/model call, Xiaoyi relay call, network call, image read by default, training/fine-tuning, app runtime transfer, or production rollout is added.

Phase OD-R7F-R2 remains backend/local-only. It aggregates five sanitized local CV calibration outputs and fixes smoke CLI fixture-root path handling in backend QA only. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, app bundle artifact, Camera behavior, live cloud AI path, upload path, provider/model key, direct provider/model call, network call, image read by default, tuning/runtime handoff, or production rollout is added.

Phase OD-R8A is backend-only Parameter Tuning Harness dry-run work. Xcode behavior should remain unchanged: no Swift file, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training/fine-tuning, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.
...
Phase OD-R8C is backend/local-only Parameter Tuning Aggregation Bridge work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training/fine-tuning, parameter-pack export, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R8D is backend/local-only Parameter Tuning Dry-run From Bridge work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training/fine-tuning, parameter-pack export, app runtime write, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R8E is backend/local-only Reviewed Candidate Acceptance Gate work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training/fine-tuning, parameter-pack export, app runtime write, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.

Phase OD-R8F is backend/local-only Parameter-pack Candidate Builder work. Xcode behavior should remain unchanged: no Swift file, Xcode project change, model file, Core ML package, model install, CV inference, Camera integration, live frame processing, upload path, provider/model key, direct provider/model call, provider SDK, Xiaoyi relay call, crawler/download mode, image read/upload, cloud teacher runtime call, network call, training/fine-tuning, parameter-pack export, app runtime write, app runtime transfer, real dataset/photo/local config/generated report, or production rollout is added.
